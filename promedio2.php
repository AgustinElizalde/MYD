...
<body>
    ...
    <header>
        <a href="index.php" class="logo"><img class="log" src="img/GENNS-PhotoRoom.png-PhotoRoom.png" alt="GENNS"></a>
    ...
    <main>
        ...
        <script>
            ...
            const data = JSON.parse(`<?php echo obtenerConocimientoInternet(); ?>`);
        ...
        <div class="header-btn2">
                <a href="promedio3.php" class="login2">Siguiente Grafico</a>
        </div>
        <br>
        <br>
        
        <div class="header-btn3">
                <a href="promedio.php" class="login3">Grafico Anterior</a>
        </div>
    </main>
    <br>
    <footer>
